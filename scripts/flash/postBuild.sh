...
# Copy IFWI
cp $top_repo_dir/meta-edison/scripts/flash/ifwi/edison/*.bin $build_dir/toFlash/
...
cp $top_repo_dir/meta-edison/scripts/flash/pft-config-edison.xml $build_dir/toFlash/

# Copy flashing script
cp $top_repo_dir/meta-edison/scripts/flash/flashall.sh $build_dir/toFlash/
cp $top_repo_dir/meta-edison/scripts/flash/flashall.bat $build_dir/toFlash/
cp $top_repo_dir/meta-edison/scripts/flash/filter-dfu-out.js $build_dir/toFlash/
...
# copy OTA update
cp $top_repo_dir/meta-edison/scripts/flash/ota_update.cmd $build_dir/toFlash/
